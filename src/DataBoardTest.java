...
public class DataBoardTest {
	public static void main (String[] args) {
		...
		try {
			...
			DataBoard<Data> Paolo_board = new MyDataBoard<Data>("Paolo",null);
		}
		...
		try {
			...
			DataBoard<Data> Paolo_board = new MyDataBoard<Data>(null,"1234");
		}
		catch (NullPointerException e) {
			System.out.println("OK");
			System.out.println(e);
		...
		try {
			...
			DataBoard<Data> Paolo_board = new MyDataBoard<Data>("","1234");
		}
		...
		try {
			...
			DataBoard<Data> Paolo_board = new MyDataBoard<Data>("Paolo","");
		}
		catch (IllegalArgumentException e ) {
			System.out.println("OK");
			System.out.println(e);
		...
		System.out.println("Creo qualche DataBoard ok ");
			...
			DataBoard<Data> Paolo_board = new MyDataBoard<Data>("Paolo","1234");
			System.out.println("Paolo_board, PW: 1234 ");
			DataBoard<Data> Alice_board = new MyDataBoard<Data>("Alice","alice101");
			System.out.println("Alice_board, PW: alice101 ");
			DataBoard<Data> Gigi_board = new MyDataBoard<Data>("Gigi","thebestgigio");
